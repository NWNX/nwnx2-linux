...
RADIUS_SIZE_SMALL           = 1.67
RADIUS_SIZE_MEDIUM          = 3.33
RADIUS_SIZE_LARGE           = 5.0
RADIUS_SIZE_HUGE            = 6.67
RADIUS_SIZE_GARGANTUAN      = 8.33
RADIUS_SIZE_COLOSSAL        = 10.0
...
IP_CONST_SPELLLEVEL_0                       = 0 -- hmm are these necessary?
