...
int MS_RSAVLong_value::add(MS_RSAVLong_value &)
{
	asm("leave");
...
int MS_RSAVLong_value::bits() const
{
	asm("leave");
...
int MS_RSAVLong_value::copy(MS_RSAVLong_value &)
{
	asm("leave");
...
int MS_RSAVLong_value::divide(MS_RSAVLong_value &, MS_RSAVLong_value &, MS_RSAVLong_value &)
{
	asm("leave");
...
int MS_RSAVLong_value::init(unsigned int)
{
	asm("leave");
...
int MS_RSAVLong_value::mul(MS_RSAVLong_value &, MS_RSAVLong_value &)
{
	asm("leave");
...
int MS_RSAVLong_value::shr(unsigned int)
{
	asm("leave");
...
int MS_RSAVLong_value::subtract(MS_RSAVLong_value &)
{
	asm("leave");
