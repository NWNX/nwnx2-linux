...
public:
	...
	int ComputePathNodes();
	int ComputeTriangleAdjacency();
	int ConvertToTileOrientation(int);
	...
	int GetTotalExits();
	int GetTriangleAdjacency(int, int, int *, int *, int *);
	int GetTriangleCentroid(int, float *, float *, float *);
	int GetTriangleVertices(int, int, int *, int *, int *);
	...
	int PlotIntraTilePath(CNWTile *, CNWArea *, CPathfindInformation *, float, float, float, float, unsigned long, int);
