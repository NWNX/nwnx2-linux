...
struct CNWSClient_vtbl {
    ...
    /* 0xC/12 */ CNWSDungeonMaster* (*AsNWSDungeonMaster)(CNWSClient*);
    /* 0x10/16 */ CNWSPlayer* (*AsNWSPlayer)(CNWSClient*);
};
...
struct CNWSObjectMethods {
    /* 0x0/0 */ unsigned long field_0;
    /* 0x4/4 */ unsigned long field_4;
    /* 0x8/8 */ void (*Destructor)(CGameObject*, char);
    /* 0xC/12 */ void (*SetId)(CGameObject*, int);
    /* 0x10/16 */ void (*ResetUpdateTimes)(CGameObject*);
    /* 0x14/20 */ void (*AsNWCObject)(CGameObject*);
    /* 0x18/24 */ CNWSObject* (*AsNWSObject)(CGameObject*);
    /* 0x1C/28 */ void (*AsNWCDoor)(CGameObject*);
    /* 0x20/32 */ CNWSDoor* (*AsNWSDoor)(CGameObject*);
    /* 0x24/36 */ void (*AsNWCModule)(CGameObject*);
    /* 0x28/40 */ CNWSModule* (*AsNWSModule)(CGameObject*);
    /* 0x2C/44 */ void (*AsNWCArea)(CGameObject*);
    /* 0x30/48 */ CNWSArea* (*AsNWSArea)(CGameObject*);
    /* 0x34/52 */ void (*AsNWCCreature)(CGameObject*);
    /* 0x38/56 */ CNWSCreature* (*AsNWSCreature)(CGameObject*);
    /* 0x3C/60 */ void (*AsNWCItem)(CGameObject*);
    /* 0x40/64 */ CNWSItem* (*AsNWSItem)(CGameObject*);
    /* 0x44/68 */ void (*AsNWCTrigger)(CGameObject*);
    /* 0x48/72 */ CNWSTrigger* (*AsNWSTrigger)(CGameObject*);
    /* 0x4C/76 */ void (*AsNWCProjectile)(CGameObject*);
    /* 0x50/80 */ CNWSPlayerTURD* (*AsNWSPlayerTURD)(CGameObject*);
    /* 0x54/84 */ void (*AsNWSPlaceable)(CGameObject*);
    /* 0x58/88 */ CNWSPlaceable* (*AsNWCPlaceable)(CGameObject*);
    /* 0x5C/92 */ void (*AsNWSAreaOfEffectObject)(CGameObject*);
    /* 0x60/96 */ CNWSAreaOfEffectObject* (*AsNWCAreaOfEffectObject)(CGameObject*);
    /* 0x64/100 */ CNWSWaypoint* (*AsNWSWaypoint)(CGameObject*);
    /* 0x68/104 */ CNWSEncounter* (*AsNWSEncounter)(CGameObject*);
    /* 0x6C/108 */ void (*AsNWCStore)(CGameObject*);
    /* 0x70/112 */ CNWSStore* (*AsNWSStore)(CGameObject*);
    /* 0x74/116 */ CNWSSoundObject* (*AsNWSSoundObject)(CGameObject*);
    /* 0x78/120 */ void (*AsNWCSoundObject)(CGameObject*);
    /* 0x7C/124 */ void (*AIUpdate)(CGameObject*);
