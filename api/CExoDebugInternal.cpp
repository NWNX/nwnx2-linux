...
int CExoDebugInternal::CloseLogFiles()
{
	asm("leave");
...
int CExoDebugInternal::FlushLogFile()
{
	asm("leave");
...
int CExoDebugInternal::GetCurrentTimestamp(CExoString &)
{
	asm("leave");
...
int CExoDebugInternal::OpenLogFiles(CExoString, int)
{
	asm("leave");
...
int CExoDebugInternal::WriteToLogFile(CExoString const &)
{
	asm("leave");
