...
int CExoRandInternal::GetString(unsigned short)
{
	asm("leave");
...
int CExoRandInternal::ReSeed(unsigned long, unsigned long, unsigned long, unsigned long)
{
	asm("leave");
...
int CExoRandInternal::SignalEvent()
{
	asm("leave");
